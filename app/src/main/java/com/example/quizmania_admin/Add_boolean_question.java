...
public class Add_boolean_question extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_boolean_question);
        ...
        question = findViewById(R.id.add_boolean_question);
        options = findViewById(R.id.boolean_options);
        answers = findViewById(R.id.boolean_answers);
        upload_btn = findViewById(R.id.boolean_upload);
        ...
        if (position != -1){
            questionModel = Questions.list2.get(position);
            setData();
        }
    ...
    private void upload(){
        ...
        if (correct == -1){
            Toast.makeText(Add_boolean_question.this,"Please select a correct option",Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        FirebaseDatabase.getInstance().getReference()
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    ...
                    if (position != -1){
                        Questions.list2.set(position,questionModel);
                    }else{
                        Questions.list2.add(questionModel);
                    }
                    finish();
                }
                else{
                    Toast.makeText(Add_boolean_question.this,"Something went wrong!!",Toast.LENGTH_SHORT).show();
                }
